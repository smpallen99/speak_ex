defmodule SpeakEx.Utils do
  ...
  def any_to_char_list(string) when is_binary(string), do: String.to_charlist(string)
  def any_to_char_list(list) when is_list(list), do: list
  def any_to_char_list(int) when is_integer(int), do: Integer.to_charlist(int)
  ...
  def get_channel_variable(call, variable, default) when is_binary(variable), do:
    get_channel_variable(call, String.to_charlist(variable), default)
  def get_channel_variable(call, variable, default) when is_atom(variable), do:
    get_channel_variable(call, Atom.to_charlist(variable), default)
